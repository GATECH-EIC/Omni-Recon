    ...
    def forward(self, x, labelset='', return_feature=False, input_feature=False):
        ...
        if input_feature:
            ...
            if return_feature:
                ...
                image_features = nn.functional.normalize(self.scratch.output_conv(image_features), dim=1) # ->nchw, output_conv is bilinear upsampling
                # image_features = nn.functional.normalize(image_features, dim=1) # ->nchw, output_conv is bilinear upsampling
