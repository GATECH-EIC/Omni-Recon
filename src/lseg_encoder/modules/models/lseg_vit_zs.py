...
def _make_pretrained_vitb_rn50_384(
    ...
    model = code.DPT.dpt.timm.create_model("vit_base_resnet50_384", pretrained=pretrained)
...
def _make_pretrained_vitl16_384(
    ...
    model = code.DPT.dpt.timm.create_model("vit_large_patch16_384", pretrained=pretrained)
...
def _make_pretrained_vitb16_384(
    ...
    model = code.DPT.dpt.timm.create_model("vit_base_patch16_384", pretrained=pretrained)
...
def _make_pretrained_deitb16_384(
    ...
    model = code.DPT.dpt.timm.create_model("vit_deit_base_patch16_384", pretrained=pretrained)
...
def _make_pretrained_deitb16_distil_384(
    ...
    model = code.DPT.dpt.timm.create_model(
...
def _make_pretrained_clip_vitb16_384(
    ...
    if pretrained is True or pretrained is False:
        print('** _make_pretrained_clip_vitb16_384 ==> code.DPT.dpt.timm.create_model("vit_base_patch16_384", pretrained={}) **'.format(pretrained))
        model = code.DPT.dpt.timm.create_model("vit_base_patch16_384", pretrained=pretrained)
    elif pretrained in ['clip', 'clip_fixed']:
        print('** _make_pretrained_clip_vitb16_384 ==> use default clip model **')
        model = code.DPT.dpt.timm.create_model("vit_base_patch16_384", pretrained=False)
...
def _make_pretrained_clip_vitb32_384(pretrained, use_readout="ignore", hooks=None, enable_attention_hooks=False):
    clip_pretrained, _ = clip.load("ViT-B/32", device='cuda', jit=False)
    if pretrained is True or pretrained is False:
        print('** _make_pretrained_clip_vitb32_384 ==> code.DPT.dpt.timm.create_model("vit_base_patch32_384", pretrained={}) **'.format(pretrained))
        model = code.DPT.dpt.timm.create_model("vit_base_patch32_384", pretrained=pretrained)
    elif pretrained in ['clip', 'clip_fixed']:
        print('** _make_pretrained_clip_vitb32_384 ==> use default clip model **')
        model = code.DPT.dpt.timm.create_model("vit_base_patch32_384", pretrained=False)
