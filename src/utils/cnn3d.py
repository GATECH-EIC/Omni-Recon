...
class VolumeRegularization_Large(nn.Module):
    def __init__(self):
        super().__init__()
        self.cnn3d0 = conv3dBNReLU(32,32,3,1,1)
        self.cnn3d1 = torch.nn.Sequential(
            conv3dBNReLU(32,32,3,2,1),
            conv3dBNReLU(32,32,3,1,1),
        )
        self.cnn3d2 = torch.nn.Sequential(
            conv3dBNReLU(32,32,3,2,1),
        ...
        self.d_cnn3d1 = tconv3dBNReLU(48,32,3,2,1,1)
        self.d_cnn3d2 = tconv3dBNReLU(32,32,3,2,1,1)
        self.d_cnn3d3 = tconv3dBNReLU(32,32,3,2,1,1)
...
class VolumeRegularization_Multi_Res(nn.Module):
    def __init__(self):
        super().__init__()
